...
def embedresult(response:json):
    ...
    embedresult.set_footer(text="AI숲쿤이 늙고 있어요", icon_url="https://i.imgur.com/9XNQr74.jpg")
...
def embedresult_lister(response:json):
    ...
    embedresult_lister.set_footer(text="AI숲쿤이 늙고 있어요", icon_url="https://i.imgur.com/9XNQr74.jpg")
...
def embedskill(response:json):
    ...
    embedskill.set_footer(text="AI숲쿤이 늙고 있어요", icon_url="https://i.imgur.com/9XNQr74.jpg")
...
def embedresult_jewlist(response:json):
    ...
    embedresult_jewlist.set_footer(text="AI숲쿤이 늙고 있어요", icon_url="https://i.imgur.com/9XNQr74.jpg")
...
def embedresult_goldget(response:json):
    ...
    embedresult_goldget.set_footer(text="AI숲쿤이 늙고 있어요", icon_url="https://i.imgur.com/9XNQr74.jpg")
...
def embedresult_sasalist(response:json, 닉네임:str):
    ...
    embedresult_sasalist.set_footer(text="AI숲쿤이 늙고 있어요", icon_url="https://i.imgur.com/9XNQr74.jpg")
...
def embedresult_auction(가격:int):
    ...
    embedresult_auction.set_footer(text="AI숲쿤이 늙고 있어요", icon_url="https://i.imgur.com/9XNQr74.jpg")
...
def embedresult_crystal(response:json):
    ...
    embedresult_crystal.set_footer(text="AI숲쿤이 늙고 있어요", icon_url="https://i.imgur.com/9XNQr74.jpg")
...
def embedresult_island(response:json):
    ...
    embedresult_island.set_footer(text="AI숲쿤이 늙고 있어요", icon_url="https://i.imgur.com/9XNQr74.jpg")
...
def embedresult_gearlist(response:json):
    ...
    embedresult_gearlist.set_footer(text="AI숲쿤이 늙고 있어요", icon_url="https://i.imgur.com/9XNQr74.jpg")
...
def embedresult_gear2list(response:json):
    ...
    embedresult_gear2list.set_footer(text="AI숲쿤이 늙고 있어요", icon_url="https://i.imgur.com/9XNQr74.jpg")
